...
public class Muro extends Fragment {
	...
	public void mensajes_connect() {
		...
		nameValuePairs.add(new BasicNameValuePair("usuarioActual", this.user));
		...
		try {
			...
			HttpPost httppost = new HttpPost(
					"http://infomundo.org/r/android/infomundo/red-social/obtenerMensajes.php");
